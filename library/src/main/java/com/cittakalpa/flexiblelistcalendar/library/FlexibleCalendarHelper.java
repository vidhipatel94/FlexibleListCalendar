...
public class FlexibleCalendarHelper {
    ...
    public static final SimpleDateFormat MONTH_YEAR_FORMAT = new SimpleDateFormat("MMMM yyyy", Locale.ENGLISH);

    public static String monthYearFormat(long timeInMillis) {
